...
g = ggplot(data.frame(x = x, y = y),aes(x = x, y = y), 
            frame=FALSE,xlab="Carat",ylab="Dollars",pch=21,col="black", bg="lightblue", cex=2)
g = g + geom_point(size = 3)
g = g + geom_ribbon(data = p1, aes(ymin = lwr, ymax = upr, fill = 'confidence'), alpha = 0.2) 
g = g + geom_ribbon(data = p2, aes(ymin = lwr, ymax = upr, fill = 'prediction'), alpha = 0.2) 
g = g + scale_fill_manual('Interval', values = c('salmon', 'blue'))
g
```
